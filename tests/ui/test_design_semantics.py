...
from brain.ui.contracts import Availability, OperationState
from brain.ui.design_system.semantics import (
    VisualState,
...
from brain.ui.presentation_state import ResultPhase, RuntimePresentationPhase
