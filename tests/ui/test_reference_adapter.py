...
from phasenox.ui.contracts import ReferenceComparisonCommand
...
def test_v2_reference_adapter_maps_real_multi_reference_contract(
...
def test_v2_reference_adapter_preserves_graceful_warning(product_metadata) -> None:
