...
from phasenox.infrastructure.config.models import (
    AppConfig,
    AudioConfig,
    ChromaConfig,
    EmbeddingConfig,
...
from phasenox.infrastructure.config.settings import DEFAULT_SETTINGS
...
def get_application_root() -> Path:
    ...
    # .../site-packages/phasenox/infrastructure/config. The parent of the ``phasenox``
