...
class NoisyneV2Service:
    ...
    def _mix_evaluate(self, request: ApplicationRequest) -> ApplicationResult:
        ...
        try:
            from noisyne.perception.mix_intelligence_contracts import MixIssuePolicy
    ...
    def _import_reasoning_engine(self) -> Any:
        from noisyne.perception.reasoning import PerceptualReasoningEngine
    ...
    def _rehydrate_evidence(
        ...
        from noisyne.perception.reference_contracts import ReferenceEvidenceResult
        from noisyne.perception.translation_contracts import TranslationEvidenceResult
