...
from noisyne.reference.models import ReferenceComparison, ReferenceIntent
...
class NoisyneService:
    ...
    alias from ``noisyne.application.soundbrain_service``.
    """
    ...
    def analyze(
        ...
        if request.output_path is not None and review_result.report is not report:
            from noisyne.report import ReportExporter
    ...
    def _run_reasoning(
        ...
        *,
        ...
        """
        try:
            from noisyne.reasoning.engine import ReasoningEngine
            from noisyne.reasoning.models import ReasoningContext
        except Exception as exc:
