...
from noisyne.reference.models import ReferenceMetric
...
class EngineeringEngine:
    ...
    This is a thin compatibility layer used by `noisyne.reference.service`.
    It lives in `noisyne.engineering` to keep the reference service's dependency
    direction stable while the full engineering rule engine continues to
    evolve under `noisyne.audio.engineer`.
    """
